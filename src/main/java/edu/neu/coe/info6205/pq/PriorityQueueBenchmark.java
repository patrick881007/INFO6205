...
public class PriorityQueueBenchmark {
    ...
    public static void main(String[] args) {
        ...
        for (int M : heapSizes) {
            ...
            // Binary Heap
            double timeBinaryHeap = benchmarkPriorityQueue("Binary Heap", M, insertions, deletions, false, false, random, runs);
            ...
            double timeBinaryHeapFloyd = benchmarkPriorityQueue("Binary Heap with Floyd's Trick", M, insertions, deletions, false, true, random, runs);
            ...
            // 4-ary Heap
            double timeFourAryHeap = benchmarkPriorityQueue("4-ary Heap", M, insertions, deletions, true, false, random, runs);
            ...
            double timeFourAryHeapFloyd = benchmarkPriorityQueue("4-ary Heap with Floyd's Trick", M, insertions, deletions, true, true, random, runs);
    ...
    private static double benchmarkPriorityQueue(String description, int M, int insertions, int deletions,
        ...
        Consumer<PriorityQueue<Integer>> function = pq -> {
            ...
            spilledElements.stream().max(Comparator.naturalOrder())
                    .ifPresent(max -> System.out.println("Max spilled element: " + max));
        };
